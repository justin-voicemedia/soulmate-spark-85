      ...
      {selectedVoice && (
        <div className="flex items-start gap-2 p-3 bg-muted/50 rounded-lg">
          ...
          <p className="text-sm text-muted-foreground">
            <strong>{selectedVoice.name}</strong> will be used for real-time conversations with {companionName}. 
            Voice previews are not available as these are specialized real-time voices that only work during live conversations.
          </p>
        </div>
      )}
    </div>
